...
mod m20260410_000001_create_storage_schema {
    ...
    impl MigrationTrait for Migration {
        async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
            create_sequences(manager).await?;
            Box::pin(create_deployments_table(manager)).await?;
            create_replicas_table(manager).await?;
            create_workers_table(manager).await?;
            create_worker_capabilities_table(manager).await?;
            Box::pin(create_leases_table(manager)).await?;
            create_worker_assignments_table(manager).await?;
            create_indexes(manager).await?;
            Ok(())
        }

        async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
            drop_worker_assignments_table(manager).await?;
            drop_leases_table(manager).await?;
            drop_worker_capabilities_table(manager).await?;
            drop_workers_table(manager).await?;
            drop_replicas_table(manager).await?;
            drop_deployments_table(manager).await?;
            drop_sequences(manager).await?;
            Ok(())
        }
    }

    async fn create_sequences(manager: &SchemaManager<'_>) -> Result<(), DbErr> {
    ...
    async fn create_deployments_table(manager: &SchemaManager<'_>) -> Result<(), DbErr> {
        manager
            .create_table(
                Table::create()
    ...
    async fn create_replicas_table(manager: &SchemaManager<'_>) -> Result<(), DbErr> {
        manager
            .create_table(
                Table::create()
    ...
    async fn create_workers_table(manager: &SchemaManager<'_>) -> Result<(), DbErr> {
        manager
            .create_table(
                Table::create()
                    .table(Workers::Table)
    ...
    async fn create_worker_capabilities_table(manager: &SchemaManager<'_>) -> Result<(), DbErr> {
        manager
            .create_table(
                Table::create()
    ...
    async fn create_leases_table(manager: &SchemaManager<'_>) -> Result<(), DbErr> {
        manager
            .create_table(
                Table::create()
                    .table(Leases::Table)
    ...
    async fn create_worker_assignments_table(manager: &SchemaManager<'_>) -> Result<(), DbErr> {
        manager
            .create_table(
                Table::create()
    ...
    async fn drop_worker_assignments_table(manager: &SchemaManager<'_>) -> Result<(), DbErr> {
        manager
            .drop_table(
                Table::drop()
                    .table(WorkerAssignments::Table)
    ...
    async fn drop_leases_table(manager: &SchemaManager<'_>) -> Result<(), DbErr> {
        manager
            .drop_table(Table::drop().table(Leases::Table).if_exists().to_owned())
            .await
    }

    async fn drop_worker_capabilities_table(manager: &SchemaManager<'_>) -> Result<(), DbErr> {
        manager
            .drop_table(
                Table::drop()
                    .table(WorkerCapabilities::Table)
    ...
    async fn drop_workers_table(manager: &SchemaManager<'_>) -> Result<(), DbErr> {
        manager
            .drop_table(Table::drop().table(Workers::Table).if_exists().to_owned())
            .await
    }

    async fn drop_replicas_table(manager: &SchemaManager<'_>) -> Result<(), DbErr> {
        manager
            .drop_table(Table::drop().table(Replicas::Table).if_exists().to_owned())
            .await
    }

    async fn drop_deployments_table(manager: &SchemaManager<'_>) -> Result<(), DbErr> {
        manager
            .drop_table(
                Table::drop()
                    .table(Deployments::Table)
    ...
    async fn drop_sequences(manager: &SchemaManager<'_>) -> Result<(), DbErr> {
        manager
            .get_connection()
            // PostgreSQL sequence DDL is backend-specific and clearer here than forcing it
